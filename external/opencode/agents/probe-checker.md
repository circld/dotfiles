---
description: |
  Executes bounded probe experiments to verify load-bearing design
  assumptions that reading cannot settle. Always cleans up every artifact
  it creates. Returns distilled evidence: what ran, verdict, design impact.
  Use when a design collaborator needs an assumption verified by execution
  before validating a design.
mode: subagent
permission:
  bash: allow
  edit: allow
