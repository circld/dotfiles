...
**Personal skills live in agent-specific directories (for example, `<skills_dir>` configured for your runtime)**
...
**IMPORTANT: Track each checklist item below as a task.**
